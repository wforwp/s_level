...
export const dictionaries: Record<Language, I18nDictionary> = {
  ko: {
    ...
    multiHint: "복수 선택 가능",
    selectAgePlaceholder: "14세 이하~30세 이상에서 선택해 주세요",
    resultTitle: "걸레 등급 테스트 결과",
  ...
  en: {
    ...
    selectAgePlaceholder: "Select from 14 or younger to 30 or older",
  ...
  es: {
    ...
    exitButton: "Salir",
    introTitle: "Test de Mente Sucia",
    ...
    selectAgePlaceholder: "Selecciona desde 14 o menos hasta 30 o más",
  ...
  fr: {
    ...
    exitButton: "Quitter",
    introTitle: "Test de l'Esprit Pervers",
    ...
    selectAgePlaceholder: "Sélectionnez de 14 ans ou moins à 30 ans ou plus",
  ...
  ja: {
    ...
    multiHint: "複数選択可能",
    selectAgePlaceholder: "14歳以下〜30歳以上から選択してください",
    resultTitle: "テスト結果",
